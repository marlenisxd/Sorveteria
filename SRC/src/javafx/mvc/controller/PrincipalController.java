...
public class PrincipalController implements Initializable {
    ...
    @FXML
    public void menuItemCadastroUsuarioClick() throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(ViewUsuarioController.class.getResource("/javafx/mvc/view/ViewUsuario.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
//                ViewUsuarioController u = loader.getController();
//        u.setTelaPrincipal(anchorPane);
//        u.setStagePrincipal(primaryStage);
